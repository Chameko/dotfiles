evaluate-commands %sh{
    ...
    echo "
        ...
        face global comment ${syntax_comment}+i
        face global meta ${syntax_markup}
        face global builtin ${syntax_entity}+b
        face global parameter rgb:d2a6ff
        ...
        face global PrimaryCursor rgb:0D1017,rgb:E6B450+F
        face global SecondaryCursor rgb:0D1017,rgb:95E6CB+F

        face global PrimaryCursorEol ${common_fg},${ui_guide_normal}+Bfg
        face global SecondaryCursorEol ${common_fg},${ui_guide_normal}+fg
        face global LineNumbers ${common_fg},${common_bg}
        face global LineNumberCursor ${common_accent},${common_bg}
        ...
        face global Error ${syntax_error}+cF
        ...
        face global InlayHint rgb:E6B450,rgba:6C738033

        # LSP config
        face global InfoDefault @Information
        face global InfoBlock ${syntax_keyword}
        face global InfoBullet ${syntax_operator}
        face global InfoHeader ${syntax_entity}
        face global InfoLink ${syntax_markup}
        face global InfoMono ${syntax_string}
        face global InfoDiagnosticWarning yellow
        face global InlayDiagnosticInfo default+ua
        face global InlayDiagnosticWarning yellow+ua
        face global InlayDiagnosticError red+ua
        face global InlayDiagnosticHint blue+ua
    "
}
